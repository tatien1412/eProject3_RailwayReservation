...
{
    public class UpdateReverseSeatQueueStatusHandler
    {
        ...
        public UpdateReverseSeatQueueStatusHandler(IRepository<Domain.Entities.Train, int> trainRepository,
        ...
        public async Task<Unit> Handle(UpdateReverseSeatQueueStatusQuery request, CancellationToken cancellationToken)
        {
